...
jint Java_com_djw_rtptest_audio_AudioCodec_audio_1codec_1init(JNIEnv *env,
...
jint Java_com_djw_rtptest_audio_AudioCodec_audio_1encode(JNIEnv *env,
...
jint Java_com_djw_rtptest_audio_AudioCodec_audio_1decode(JNIEnv *env,
